...
export const INITIAL_RECENTS: MockRecent[] = [
  { id: 'r1', name: 'LG C4 42" OLED', meta: 'R14 299 LOW · 3D AGO', sources: ['takealot.com', 'incredible.co.za'] },
  { id: 'r2', name: 'Logitech MX Master 3S', meta: 'R1 549 LOW · 6D AGO', sources: ['takealot.com', 'evetech.co.za'] },
  { id: 'r3', name: 'Ryzen 5 7600X', meta: 'R4 199 LOW · 11D AGO', sources: ['evetech.co.za', 'loot.co.za'] },
];
